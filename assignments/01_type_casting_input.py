...
"""
The below script will ask for 3 inputs. Each input will be based on the price of the items - the price is determined by you. 
The output should print the total of the 3 inputs rounded to 2 decimal places e.g
